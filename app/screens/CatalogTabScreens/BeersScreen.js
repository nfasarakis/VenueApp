 ...
 *
 * BeersScreen Component: Screen containing list of all beers a specific venues offers
 *
 * The BeersScreen Component receives the following props
 ...
 *
 * @return {[View]} A view-wrapped scrollable list containg all beers as items
 */
