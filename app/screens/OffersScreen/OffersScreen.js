...
import {VerticalListCard, HorizontalListCard, LoadingIcon} from '../../components';
  ...
  UNSAFE_componentWillMount() {
    ...
    this.props.navigation.setParams({
      ...
      filterStores: async (filteringParams) => {
        console.warn('Filtering Offers with ' + filteringParams);
        ...
        this.setState({stores: storesJson, recommended: recommendedJson, isLoading: false});
      },
